...
import "codemirror/mode/clike/clike"; // Use the 'clike' mode for Java
...
function JavaEditor() {
  const initialCode = `// Welcome to Java Editor\n\npublic class HelloWorld {
      ...
      <Container fluid>
        <Row style={{ justifyContent: "center", padding: "25px" }}>
          <Col md={6} className="text-center">
            <h3 className="text-center">Java Editor</h3>
            <CodeMirror
              value={code}
              options={{
                mode: "text/x-java",
            ...
            <Button onClick={handleCompile} disabled={processing}>
              {processing ? "Compiling..." : "Compile and Run Java Code"}
            </Button>
          </Col>
          <Col md={6} style={{ paddingTop: "35px" }}>
            <h3 className="text-center">Java Output</h3>
